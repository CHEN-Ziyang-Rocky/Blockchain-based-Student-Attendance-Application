...
class Blockchain {
    ...
    async addTransaction(newTransaction, emit = true) {
        ...
        console.log("test1", newTransaction);
    ...
    async checkTransaction(transaction, referenceBlockchain = this.blocks) {
        ...
        console.log("transaction.data.inputs:", transaction.data.inputs);
        ...
        console.log("isInputTransactionsUnspent:", isInputTransactionsUnspent);
